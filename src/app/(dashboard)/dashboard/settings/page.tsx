        ...
        <div className="space-y-6">
          {platformLoading ? (
            ...
            <>
              ...
              <div className="bg-card rounded-xl border border-border p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input value={`${settings?.defaultCommissionRate ?? 10}%`} readOnly className={readOnlyCls} />
                  </div>
                  <div>
              ...
              {/* Commission Rules */}
              <div className="bg-card rounded-xl border border-border p-6">
                <h3 className="font-semibold mb-4">Commission Rules</h3>
                {commissionRules.length > 0 ? (
                  ...
                  <p className="text-sm text-muted-foreground">No commission rules configured. Using default rate of {settings?.defaultCommissionRate ?? 10}%.</p>
                )}
              </div>
